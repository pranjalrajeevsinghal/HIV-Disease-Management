                ...
                <div class="card-body p-5 text-center">
                  ...
                  <div class="mb-md-5 mt-md-4 pb-5">
                    ...
                    <div class="form-outline form-white mb-4">
                      <input type="text" name="DocId" id="typeEmailX" class="form-control form-control-lg" />
                      <label class="form-label" for="typeEmailX">Doctor ID</label>
                    </div>
                  ...
                  <div>
                    <p class="mb-0">Don't have an account? <a href="/HIV/Final Review/signup.php" class="text-white-50 fw-bold">Sign Up</a>
                    </p>
                  </div>
    ...
    if(isset($_POST['login']))
    {
        ...
        else
        {
            ...
            if($row=mysqli_fetch_assoc($result))
            {
                ...
                if(($pass)== $db_pass)
                {
                    header('location: /HIV/Final Review/docform.php');
                }
                else
                {
